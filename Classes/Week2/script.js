...
//2. Each row contains information of a user: ID, Name, Phone number and Height..all separated by the commas.
//   Split each row into an array with all diffferent fields. ...You need to deal with extra and/or no whitespace between commas.
...
// 5. Check if the height field has "cm" at the end.
// If it does, strip that out, converthe the number to inches, and turn it into a string in the form of "xx inches".
// For example "152 cm" should become "59 inches"
...
function processCSV(csv) {
  ...
  // 4 different examples of doing it
  // let data = [];
