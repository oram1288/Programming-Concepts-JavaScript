...
// function getHello(str) {
//   return str.includes("hello") ? "True" : "False";
// }
...
console.log(cleanUp('This ois "fun"'));
...
function fixPostalCode(postalCode) {
  ...
  if (!postalCodeRegex.test(fixed)) {
    throw new Error(`postal code includes invaild characters`);
  }

  // if the postal code is only 6 characters, inster a space in the middle
  if (fixed.length === 6) {
...
console.log(fixPostalCode("n1e0e9"));
