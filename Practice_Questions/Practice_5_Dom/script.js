...
window.addEventListener("DOMContentLoaded", function () {
  ...
  ******************************************************************************************************************/
  ...
  problem2.addEventListener("click", function () {
    ...
    this.document.querySelector("#p2").appendChild(img);
    });
  });
  ...
  ******************************************************************************************************************/
  let button3 = document.querySelector("#problem3");
      
  button3.addEventListener("click", function () {
    let S = document.createElement("p3txt").value;
    let p = document.createElement("p");
    p.innerText = S.toUpperCase();
  ...
  ******************************************************************************************************************/
  var myList = [];
  let button4 = document.querySelector("#problem4");
  button4.addEventListener("click", function () {
    myList.push(document.querySelector("p4").value);
  ...
  ******************************************************************************************************************/
  let button5 = document.querySelector("#problem5");
  button5.addEventListener("click", function () {
    ...
    document.querySelector("#p5").appendChild(ul);
  });
});